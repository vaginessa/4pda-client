...
//        }
    ...
    inner class FullItem(itemView: View?) : RecyclerView.ViewHolder(itemView) {
        ...
        val clickableConatiner: LinearLayout = itemView?.findViewById(R.id.news_list_item_clickable_container) as LinearLayout
        ...
        fun bind(model: News, position: Int) {
            ...
            clickableConatiner.setOnClickListener { clickListener?.itemClick(it, position) }
        }
