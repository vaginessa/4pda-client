        ...
        template.apply {
            ...
            for (post in page.posts) {
                ...
                if (page.posts.size > 1 && hatPostId == post.id) {
                    ...
                    setVariableOpt("hat_state_class", if (prevDisabled || page.isHatOpen) "open" else "close")
            ...
            if (page.poll != null) {
                ...
                setVariableOpt("poll_title", if (poll.title.isEmpty() || poll.title == "-") App.get().getString(R.string.poll) else poll.title)
