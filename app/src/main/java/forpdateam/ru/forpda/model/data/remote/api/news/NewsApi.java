...
import forpdateam.ru.forpda.model.data.remote.api.regex.RegexStorage;
...
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_CATEGORY_ALL;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_CATEGORY_ARTICLES;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_CATEGORY_GAMES;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_CATEGORY_REVIEWS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_CATEGORY_ROOT;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_CATEGORY_SOFTWARE;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_ACCESSORIES_REVIEWS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_ACOUSTICS_REVIEWS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_ANDROID_GAME;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_ANDROID_SOFTWARE;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_DEVSTORY_GAMES;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_DEVSTORY_SOFTWARE;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_HOW_TO_ANDROID;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_HOW_TO_INTERVIEW;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_HOW_TO_IOS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_HOW_TO_WP;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_IOS_GAME;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_IOS_SOFTWARE;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_NOTEBOOKS_REVIEWS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_SMARTPHONES_REVIEWS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_SMART_WATCH_REVIEWS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_TABLETS_REVIEWS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_WP7_GAME;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_SUBCATEGORY_WP7_SOFTWARE;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_ACCESSORIES_REVIEWS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_ACOUSTICS_REVIEWS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_ALL;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_ANDROID_GAME;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_ANDROID_SOFTWARE;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_ARTICLES;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_DEVSTORY_GAMES;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_DEVSTORY_SOFTWARE;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_GAMES;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_HOW_TO_ANDROID;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_HOW_TO_INTERVIEW;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_HOW_TO_IOS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_HOW_TO_WP;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_IOS_GAME;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_IOS_SOFTWARE;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_NOTEBOOKS_REVIEWS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_REVIEWS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_ROOT;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_SMARTPHONES_REVIEWS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_SMART_WATCH_REVIEWS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_SOFTWARE;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_TABLETS_REVIEWS;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_WP7_GAME;
import static forpdateam.ru.forpda.model.data.remote.api.news.Constants.NEWS_URL_WP7_SOFTWARE;
